...
//    ecryptfs_opt_encrypted_view, ecryptfs_opt_err };	/* HMAC PATCH */
	ecryptfs_opt_encrypted_view, ecryptfs_opt_hmac, ecryptfs_opt_err,};	/* HMAC PATCH */
...
//	{ecryptfs_opt_err, NULL}	/* HMAC PATCH */
	{ecryptfs_opt_hmac, "ecryptfs_hmac"},	/* HMAC PATCH */
	{ecryptfs_opt_err, NULL},	/* HMAC PATCH */
};
...
static int ecryptfs_parse_options(struct super_block *sb, char *options)
{
	...
	while ((p = strsep(&options, ",")) != NULL) {
		...
		case ecryptfs_opt_encrypted_view:
			...
			break;
		case ecryptfs_opt_hmac:	/* HMAC PATCH */
			mount_crypt_stat->flags |= ECRYPTFS_ENABLE_HMAC;	/* HMAC PATCH */
			break;	/* HMAC PATCH */
...
static struct ecryptfs_cache_info {
	...
	{	/* HMAC PATCH */
		.cache = &ecryptfs_extent_cache,	/* HMAC PATCH */
		.name = "ecryptfs_extent_cache",	/* HMAC PATCH */
		.size = ECRYPTFS_DEFAULT_EXTENT_SIZE/*4096*/,	/* HMAC PATCH */
	},	/* HMAC PATCH */
};
